...
plot(res.mca,label = c("var","ind"),cex=.8,selectMod = "contrib 10")
...
write.infile(res.hcpc$data.clust,file="C:\\Users\\varunn\\Documents\\Confluence attachments\\Finance service research\\clusterdata1.csv",sep = ';',append=FALSE,nb.dec=4)
